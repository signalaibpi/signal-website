...
const CARDS = [
  ...
  },
  {
    ...
    body: "Creates an evidence base for measuring improvement in future progress reviews.",
  },
];
    ...
    <section className="w-full bg-surface-container-lowest py-16 sm:py-20 border-b border-outline-variant/20">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-16 flex flex-col gap-14">
        <div className="max-w-3xl flex flex-col gap-4">
          <SectionEyebrow>AI Progress Review</SectionEyebrow>
          ...
          <p className="font-body text-xl leading-relaxed text-on-surface-variant">
            Our AI Progress Review assesses use of AI across the business
            using 12 dimensions and gives an evidence-based view of strengths,
            gaps and suggested priorities for improvement.
          </p>
        </div>
